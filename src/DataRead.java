...
public class DataRead {
    ...
    private ArrayList<String> lineString = null;
                ...
                if (text.length() > 0 && text.charAt(0) == '#') {
                    ...
                    if (hashCount == 1) {
                        ...
                        if(!text.equals("-1"))
                        {
                            ...
                            if(Integer.parseInt(splited[0]) != lineNumber - 2)
                            {
                                System.out.println("Nieprawidłowe ID waluty w linii " + lineNumber +", ID zostało ustawione na wartość: " + (lineNumber - 2));
                                splited[0] = String.valueOf(lineNumber - 2);
                            }
        ...
        if (currencyNameRead) {
            ...
            while(true) {
                ...
                if (text.equals("W")) {
                    ...
                    return checkData(text, currencyNameRead, lineNumber);
                }
            }
        } else {
            if (splited.length == 6) {
